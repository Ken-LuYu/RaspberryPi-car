...
./mjpg_streamer -i "./input_uvc.so -n -f 20 -r 2560x1440 -ex auto -br 45" -o "./output_http.so -w ./www"
...
./mjpg_streamer \
  ...
  > /home/pi/mjpg_streamer.log 2>&1 &

echo "✅ mjpg-streamer 已启动"
echo "📺 视频流地址：http://$(hostname -I | awk '{print $1}'):8080/?action=stream"
echo "💡 配置：2560x1440 @20fps，JPEG质量75%"